...
function getPattern() {
  ...
  var freqArr = freqStr.split(" "); //console.log(freqArr);

  var i;
  var startNumber = 0;

  for (i = 0; i < freqArr.length; i++) {
    startNumber = startNumber + Number(freqArr[i]); //console.log(startNumber);
...
function runAgain(startNumber, freqArr, allStartNum) {
  ...
  for (i = 0; i < newFreqArr.length; i++) {
    newStartNumber = newStartNumber + Number(newFreqArr[i]); //console.log(startNumber);
    //console.log(startNumber);
...
function getBoxId() {
  ...
  var boxArr = boxStr.split(" "); //console.log(boxArr);
